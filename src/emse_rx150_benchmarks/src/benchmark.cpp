...
public:
    ...
    bool performBenchmark() {
        ...
        results_file << "position_x,position_y,position_z,orientation_x,orientation_y,orientation_z,orientation_w,success,planning_time,trajectory_length\n";
        ...
        for (const auto& pose : poses_) {
            ...
            RCLCPP_INFO(this->get_logger(), "Planning for pose [%f, %f, %f,%f, %f, %f, %f]", pose.position.x, pose.position.y, pose.position.z , pose.orientation.x, pose.orientation.y, pose.orientation.z, pose.orientation.w);
            ...
            results_file << pose.position.x << "," << pose.position.y << "," << pose.position.z << ","
                         ...
                         << success << "," << planning_time << "," << trajectory_length << "\n";

            RCLCPP_INFO(this->get_logger(), "Pose [%f, %f, %f] - Success: %d, Planning Time: %f, Trajectory Length: %f",
                        pose.position.x, pose.position.y, pose.position.z, success, planning_time, trajectory_length);
