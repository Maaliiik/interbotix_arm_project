...
def launch_setup(context, *args, **kwargs):
    ...
    warehouse_ros_config = {
        ...
        "warehouse_host": "/home/malik/interbotix_moveit/src/emse_rx150_moveit_config/data/warehouse_db.sqlite"
    }
    ...
    move_group_node = Node(
        ...
        output="screen",
        parameters=[moveit_config.to_dict(), {"use_sim_time": use_sim_time_param} ,planning_scene_monitor_parameters, kinematic_parameter,warehouse_ros_config],
        remappings=[
